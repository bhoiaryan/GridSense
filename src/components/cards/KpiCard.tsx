    ...
    <article className="panel p-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-2 text-2xl font-semibold tracking-normal text-grid-ink">{kpi.value}</p>
        </div>
        <div className="rounded-md border border-grid-line bg-slate-50 p-2 text-grid-teal">
          <Icon size={18} />
        </div>
      </div>
      ...
      <p className="mt-3 border-t border-grid-line pt-3 text-xs font-medium text-grid-ink">{kpi.trend}</p>
    </article>
  );
}
